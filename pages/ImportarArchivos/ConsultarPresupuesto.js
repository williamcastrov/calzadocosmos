...
function ConsultarPresupuesto(props) {
    const { tipo, setTipo, ventasDiariasMes, listaPresupuestos } = props;
    ...
    const generarConsulta = () => {
        ...
        //return
        listaPresupuestos.presupuestosventas &&
            listaPresupuestos.presupuestosventas.map((ppto, index) => {
...
export default ConsultarPresupuesto;