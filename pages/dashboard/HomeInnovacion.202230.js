...
import TabVtasDiariasFiltro from "../../components/Tab/TabVtasDiariasFiltro";
import TabCostosVentas from "../../components/Tab/TabCostosVentas";
...
export default function HomeInnovacion(props) {
    const { ventasDiariasMes, existencias } = props;
                                    ...
                                    {tailsvtas.map((card) => (
                                        card.name === 'Ventas' ? (
                                            <TileIcon
                                                ...
                                                s//ubtexto={'Cte: ' + myNumber(1, (undvtasmesact / 1000)) + " Und - " + myNumber(1, (pesosvtasmesact / 1000000)) + ' MM'}
                                                icono={mdiCashCheck}
                                                //pie={'Ant: ' + myNumber(1, (undvtasmesant.UND_ANT / 1000)) + "K Und - " + myNumber(1, (pesosvtasmesant / 1000000)) + 'MM'}
                                                funcion={null}
                                                opcion={0}
                                            />
                                            ...
                                            <TileIcon
                                                ...
                                                opcion={0}
                                            />
                                        ) : card.name === 'Participacion' ? (
                                            <TileIcon
                                                clrH={CST.lilaHdr}
                                                clrB={CST.lilaBdy}
                                                clrF={CST.lilaFoo}
                                                //title={"Participación Acum. - " + nameMonth(mesact)}
                                                //texto={vtasProductos.participacionproducto[0].Descripcion}
                                                //subtexto={vtasProductos.participacionproducto[1].Descripcion + " - " + myNumber(1, (((vtasProductos.participacionproducto[1].MND_TOT) / datosCostos.costosvta.MND_TOT)) * 100) + " % "}
                                                icono={mdiDecimalIncrease}
                                                //pie={vtasProductos.participacionproducto[2].Descripcion}
                                                funcion={null}
                                                opcion={0}
                                            />
                                        ) : (
                                            <TileIcon
                                                ...
                                                clrF={CST.greyFoo}
                                                title={"Variación"}
                                                //texto={nameMonth(mesact) + ' - ' + anoact + ' ' + myNumber(1, (0)) + 'MM'}
                                                subtexto={'...'}
                                                icono={mdiTrendingUp}
                                                //pie={nameMonth(totalcompras.mes_anterior) + ' - ' + totalcompras.ano_anterior + ' ' + myNumber(1, (0)) + 'MM'}
                                                funcion={null}
                                                opcion={0}
                                            />
                                        )
                                ...
                                <h2 className="mx-auto mt-2 px-4 text-lg leading-6 font-medium text-gray-900 sm:px-6 lg:px-8">
                                    ...
                                    <div className="hidden sm:block">
                                        ...
                                        </div>
                                        {
                                            tabVtasLinea ?
                                                (
                                                    <TabInformeVtas tipo={tipo} setTipo={setTipo}
                                                    ...
                                                    (
                                                        <TabCostosVentas tipo={tipo} setTipo={setTipo}
                                                            ventasDiariasMes={ventasDiariasMes}
                                                        />
                                                    ) :
                                                    null
