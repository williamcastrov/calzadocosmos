            ...
            <div className="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    <img
                        ...
                        alt="Workflow"
                    />
                    <h2 className="mt-6 text-center text-3xl tracking-tight font-bold text-gray-900">Iniciar sesión en su cuenta</h2>
                    <p className="mt-2 text-center text-sm text-gray-600">
                        
                        <a href="#" className="text-2xl text-black font-bold hover:textcolorcomos">
                            Sistema de Gestión Calzado Cosmos
                        </a>
                    </p>
                </div>
